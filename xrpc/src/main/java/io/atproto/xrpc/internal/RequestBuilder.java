...
public final class RequestBuilder {
     ...
     */
    public static String buildUrl(String baseUrl, String nsid, io.atproto.xrpc.QueryParams params) {
     ...
     */
    public static RequestBody encodeBody(LexValue data, String contentType, LexJsonConverter converter) throws IOException {
        if (data == null) return null;
        String json = converter.lexToJsonString(data);
        return RequestBody.create(json, MediaType.parse(contentType != null ? contentType : "application/json"));
    }
