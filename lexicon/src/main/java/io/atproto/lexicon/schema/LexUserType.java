...
/**
 * Sealed hierarchy for all definition types in an AT Protocol Lexicon document.
 * Dispatch is on the "type" JSON field.
 */
...
public sealed interface LexUserType
        permits LexRecord, LexQuery, LexProcedure, LexSubscription,
                LexObject, LexBlob, LexArray, LexToken,
                LexBoolean, LexInteger, LexString, LexBytes, LexCidLink,
                LexRef, LexRefUnion, LexUnknown {
