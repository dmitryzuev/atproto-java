...
public final class LexiconValidator {
    ...
    private ValidationResult validateArray(String lexUri, com.atproto.lexicon.schema.LexArray def, LexValue value) {
    ...
    private ValidationResult validateBooleanDef(String lexUri, com.atproto.lexicon.schema.LexBoolean def, LexValue value) {
    ...
    private ValidationResult validateIntegerDef(String lexUri, com.atproto.lexicon.schema.LexInteger def, LexValue value) {
    ...
    private ValidationResult validateStringDef(String lexUri, com.atproto.lexicon.schema.LexString def, LexValue value) {
    ...
    private ValidationResult validateBytesDef(String lexUri, com.atproto.lexicon.schema.LexBytes def, LexValue value) {
