...
/**
 * Top-level AT Protocol Lexicon document.
 * Example file: {"lexicon":1,"id":"app.bsky.feed.post","defs":{...}}
 */
...
public record LexiconDoc(
    ...
    public LexiconDoc {
        ...
        if (id == null || id.isBlank()) throw new IllegalArgumentException("LexiconDoc id must not be blank");
