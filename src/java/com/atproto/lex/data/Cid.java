...
import com.atproto.lex.data.util.VarintUtils;
...
/**
 * CIDv1 content identifier as used in the AT Protocol. Wire format:
 * [version-varint][codec-varint][mh-code-varint][mh-len-varint][digest] String format: multibase
 * 'b' + base32-lower (RFC 4648, no padding).
 */
public record Cid(int version, int codec, Multihash multihash) {
    ...
    if (prefix != 'b' && prefix != 'B') {
      throw new LexError(
          "Unsupported CID multibase prefix: '"
              + prefix
              + "' (only base32-lower 'b' is supported)");
    }
  ...
  public boolean equals(Object o) {
    ...
    return version == other.version && codec == other.codec && multihash.equals(other.multihash);
  }
