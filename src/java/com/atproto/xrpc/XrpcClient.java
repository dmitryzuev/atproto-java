...
import com.atproto.lexicon.schema.LexUserType;
import com.atproto.lexicon.schema.LexiconDoc;
import com.atproto.xrpc.error.*;
import com.atproto.xrpc.internal.RequestBuilder;
import com.atproto.xrpc.internal.ResponseParser;
...
public final class XrpcClient {
   ...
   */
  public XrpcResponse call(String nsid, QueryParams params, LexValue data, CallOptions opts)
    ...
    String httpMethod =
        (def != null) ? RequestBuilder.httpMethod(def) : (data != null ? "POST" : "GET");
    ...
    try {
      if ("GET".equals(httpMethod)) {
        ...
        String contentType =
            (opts != null && opts.encoding() != null) ? opts.encoding() : "application/json";
        okhttp3.RequestBody body =
            data != null
                ? RequestBuilder.encodeBody(data, contentType, jsonConverter)
                : okhttp3.RequestBody.create(
                    new byte[0], okhttp3.MediaType.parse("application/json"));
  ...
  public CompletableFuture<XrpcResponse> callAsync(
      String nsid, QueryParams params, LexValue data, CallOptions opts) {
    return callAsync(nsid, params, data, opts, ForkJoinPool.commonPool());
  }

  public CompletableFuture<XrpcResponse> callAsync(
      String nsid, QueryParams params, LexValue data, CallOptions opts, Executor executor) {
